...
export const CcTextFieldInputTextStyles = {
  defaultStyles:
    "placeholder:cc-text-grey-400 placeholder:cc-text-sm cc-border cc-border-neutral-300 focus:cc-border-primary-100 cc-outline-none cc-text-sm",
  disabledStyles:
...
export const CcTextFieldHelperDefaultSyles =
  "cc-text-xs cc-font-regular cc-mt-1";

export const CcTextFieldHelperTextStyles = "cc-text-neutral-500";

export const CcTextFieldErrorTextStyles = "cc-text-error-500";

export const CcTextFieldSuccessTextStyles = "cc-text-success-500";
